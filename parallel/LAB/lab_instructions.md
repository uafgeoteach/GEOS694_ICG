...
- Rewrite the script so that is can be parallelized 
- Consider what tasks can be independent, and what tasks require communication
- You can use the multiple terminals, Bash script, or subprocess approach (see lecture slides and example scripts in this directory)
- You can write additional scripts, make new files, etc. to make this work
- Break the problem into 4 tasks
