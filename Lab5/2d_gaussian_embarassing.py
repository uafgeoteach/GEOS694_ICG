...
def main(xmin, xmax, ymin, ymax, sigma=1):
    ...
    for x in X:
        for y in Y:
            Z.append(gaussian2D(x, y, sigma))  # 2D array
...
if __name__ == "__main__":
    ...
    # splitting along horizontal and vertical
    main(0, 2, 0, 2, "First Quarter")
    main(0, 2, -2, 0, "Second Quarter")
    main(-2, 0, -2, 0, "Third Quarter")
    main(-2, 0, 0, 2, "Last Quarter")
